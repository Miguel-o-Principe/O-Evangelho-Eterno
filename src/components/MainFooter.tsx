...
export const MainFooter = () => {
    ...
    const isAboutBook = location.pathname === '/sobre-a-obra';
    const isChapters = location.pathname === '/capitulos';
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4">
                ...
                {isChapters ? (
                    <>
                        ...
                        <Link className="text-slate-500 dark:text-slate-400 hover:text-primary transition-colors text-sm font-medium" to="/sobre-o-autor">Sobre o Autor</Link>
                    </>
                ) : isAboutBook ? (
                    <Link className="text-slate-500 dark:text-slate-400 hover:text-primary transition-colors text-sm font-medium" to="/capitulos">Capítulos</Link>
                ) : (
                    <>
                        <Link className="text-slate-500 dark:text-slate-400 hover:text-primary transition-colors text-sm font-medium" to="/sobre-a-obra">Sobre a Obra</Link>
                        <Link className="text-slate-500 dark:text-slate-400 hover:text-primary transition-colors text-sm font-medium" to="/capitulos">Capítulos</Link>
                ...
                <Link className="text-slate-500 dark:text-slate-400 hover:text-primary transition-colors text-sm font-medium" to="/login?action=register">Cadastro no Portal</Link>
            </div>
