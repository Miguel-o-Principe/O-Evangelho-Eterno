                                    ...
                                    <form onSubmit={handleLogin} className="space-y-6" autoComplete="off">
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input type={showPassword ? "text" : "password"} name="password" autoComplete="new-password" value={password} onChange={e => setPassword(e.target.value)} onKeyDown={e => { if (e.key === 'Enter') e.currentTarget.form?.requestSubmit(); }} required className="w-full bg-slate-50 dark:bg-slate-900/40 border border-slate-100 dark:border-slate-800 rounded-xl py-3.5 pl-11 pr-11 focus:ring-2 focus:ring-primary/40 transition-all outline-none text-sm" placeholder="••••••••" />
