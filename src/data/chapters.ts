export const chapters = [
    {
        ...
        img: "/images/capitulo-1-bg.png",
        desc: `Descubra como os "Nãos" da Lei não freiam o pecado, mas funcionam como a verdadeira força do Desejo.`
    },
    {
        id: "2",
        n: "02",
        title: "A Serpente",
        img: "/images/capitulo-2-bg.png",
        desc: `Entenda a surpreendente simbiose entre Satanás e a Lei.`
    },
    {
        id: "3",
        n: "03",
        title: "As Folhas de Figueira",
        img: "/images/capitulo-3-bg.png",
        desc: `A Religião desmascarada como mera gestão simbólica da vergonha: Explore a ilusão da obediência.`
    },
    {
        id: "4",
        n: "04",
